...
- clean stale generated files only from the dedicated default `build/gmd` output directory; custom target directories retain pre-existing files while Gradle tracks their expected generated files individually for up-to-date checks
