...
## v3.2.0, unreleased
- derive the default GMD core version from a generated plugin-version resource, then the artifact manifest, with a released fallback for older and repackaged builds
